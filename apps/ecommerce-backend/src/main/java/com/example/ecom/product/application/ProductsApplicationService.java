package com.example.ecom.product.application;
...
import com.example.ecom.product.domain.aggregate.FilterQuery;
import com.example.ecom.product.domain.aggregate.Product;
import com.example.ecom.product.domain.repository.CategoryRepository;
import com.example.ecom.product.domain.repository.ProductRepository;
import com.example.ecom.product.domain.service.CategoryCRUD;
import com.example.ecom.product.domain.service.ProductCRUD;
import com.example.ecom.product.domain.service.ProductShop;
import com.example.ecom.product.domain.service.ProductUpdater;
